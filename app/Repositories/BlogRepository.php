...
class BlogRepository implements CrudRepositoryInterface
{
    /**
    ...
    public function getAll(Request $request): LengthAwarePaginator
    {
        ...
        return Blog::query()->with('comments', 'likes')
    ...
    {
        return Blog::query()->with('comments', 'likes')->find($id);
    }
    ...
    {
        return Blog::query()->create($requestData);
    }
